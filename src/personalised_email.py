...
I noticed your impressive background in [Current experience] at [Company]. Your expertise in [Company industry] aligns perfectly with our AI-Powered Analytics Platform.
...
def generate_email_for_single_lead(lead_details: dict, product_details: str) -> dict:
    ...
    Returns:
        dict: Dictionary containing 'subject' and 'body' of the email
    """
...
Return the results in a dictionary with two keys:
...
def generate_email_for_multiple_leads(leads_list: list, product_details: str) -> list:
    ...
    Returns:
        list: List of dictionaries, each containing 'subject' and 'body' of the email
    """
    if not leads_list:
